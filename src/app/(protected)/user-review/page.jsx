...
import CloudinaryImageUploader from "./CloudinaryImageUploader"; // Updated component
...
export default function ReviewForm({ toiletId = "148" }) {
    ...
    //         toast.error(translations[lang].messages.fillRequired);
    //         return;
    //     }
    ...
    //         const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/reviews/user-review`, {
    //             method: "POST",
    //             body: formData,
    //         });
    ...
    //         toast.error(err.message || translations[lang].messages.submitError);
    //     } finally {
