        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-slate-200/60">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 mt-2">
                Select a cleaner and locations to create assignments
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-center gap-2 text-sm text-blue-700">
              ...
              <span>
                <strong>{allUsers.length} cleaners available</strong> for assignment
            ...
            <div className="pt-6 border-t border-slate-200">
              ...
              >
                {isLoading
                  ...
                  : `Create ${selectedLocations.length} Assignment${selectedLocations.length !== 1 ? 's' : ''}`}
              </button>
            </div>
          </form>
        </div>
