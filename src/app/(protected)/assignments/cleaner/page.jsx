...
export default function CleanersPage() {
    ...
    const handleView = (assignmentId) => {
        router.push(`/assignments/cleaner/${assignmentId}?companyId=${companyId}&locationId=${locationId}`);
    };

    const handleEdit = (assignmentId) => {
        router.push(`/assignments/cleaner/${assignmentId}/edit?companyId=${companyId}&locationId=${locationId}`);
    };
