...
export const ReportsApi = {
  ...
  /**
   * Get available zones for zone-wise report
   */
  getAvailableZones: async (company_id) => {
    try {
      const response = await axiosInstance.get(
  ...
  /**
   * ✅ NEW: Get locations for daily task report filter
   */
  getLocationsForReport: async (company_id) => {
    try {
      const response = await axiosInstance.get(
        `/reports/locations?company_id=${company_id}`
      );
  ...
  /**
   * ✅ NEW: Get cleaners for daily task report filter
   */
  getCleanersForReport: async (company_id) => {
    try {
      const response = await axiosInstance.get(
        `/reports/cleaners?company_id=${company_id}`
      );
